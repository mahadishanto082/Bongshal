...
{
    use Media;
    protected $ASSET_PATH = 'merchants';
    protected $ROUTE_AND_VIEW = 'admin.merchants.';
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route($this->ROUTE_AND_VIEW.'index'))->with('success', 'Merchant create successfully');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($data) {
            ...
            return redirect(route($this->ROUTE_AND_VIEW.'index'))->with('success', 'Merchant update successfully');
        } else {
    ...
    public function destroy(string $id)
    {
        ...
        if ($data) {
            ...
            $data->delete();
            return redirect(route($this->ROUTE_AND_VIEW.'index'))->with('success', 'Merchant delete successfully');
        } else {
            return redirect(route($this->ROUTE_AND_VIEW.'index'))->with('warning', 'Something went wrong. Please try again !!');
        }
    }
