        ...
        <nav class="nav">
                    ...
                    <div class="media-list">
                        @if(count(newOrderCount()) > 0)
                            ...
                            <div class="dropdown-footer">
                                <a href="#"><i class="fa fa-angle-down"></i> Show All Orders</a>
                            </div>
                        @else
            ...
            <div class="dropdown">
                <a href="#" class="nav-link nav-link-profile" data-toggle="dropdown">
                    <span class="logged-name hidden-md-down">{{ Auth::guard('vendor')->user()->name }}</span>
                    <img style="width: 30px; height: 30px" src="{{ asset(auth('vendor')->user()->image ? 'storage/' . auth('vendor')->user()->image : 'assets/vendor/img/img1.jpg') }}" class="wd-32 rounded-circle" alt="">
                    <span class="square-10 bg-success"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-header wd-250">
                    <div class="tx-center">
                        <a href="#">
                            <img style="width: 80px; height: 80px" src="{{ asset(auth('vendor')->user()->image ? 'storage/' . auth('vendor')->user()->image : 'assets/vendor/img/img1.jpg') }}" class=" rounded-circle" alt="">
                        </a>
                        <h6 class="logged-fullname">{{ Auth::guard('vendor')->user()->name }}</h6>
                    ...
                    <ul class="list-unstyled user-profile-nav">
                        <li>
                            <a href="#"
                               @if(Request::routeIs('vendor.profile.update')) class="active" @endif
                            >
