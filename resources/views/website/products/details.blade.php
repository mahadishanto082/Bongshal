                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list-inline d-flex justify-content-end">
                                            ...
                                            <i class="fas fa-expand" style="color:#fa4c06;"></i>
                                                <a href="{{ asset('storage/products/' . $product->image) }}" class="text-decoration-none" data-lightbox="product-image"> 
                                                    Full Screen
                                                </a>   
                                    ...
                                    <div class="row justify-content-start">
                                        <div class="col-md-6 mb-3">
                                            <div class="card border p-2" style="width: 220%;">
                                                <iframe 
                                                    width="100%" 
                                                    height="200" 
                                        ...
                                        <ul class="list-inline d-flex justify-content-end">
                                            <li class="list-inline-item">
                                                <a href="https://example.com" style="color:#fa4c06; text-decoration: none;">More videos</a>
                                            </li>
                                        </ul>
                            ...
                            <div class="row justify-content-center">
                                  <div class="col-md-8 col-sm-10 col-12">
                                    <div class="sec_title text-center mb-2">
                                        <h5 class="ft-bold mb-0">Reviews and Questions</h5>
                                    </div>
                                </div>
                            </div>
                            <ul class="nav nav-tabs justify-content-start" id="productTab" role="tablist">
